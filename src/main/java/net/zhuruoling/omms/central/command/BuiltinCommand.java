                        ...
                        return 0;
                            ...
                            RequiredArgumentBuilder.<CommandSourceStack, String>argument("controller", StringArgumentType.greedyString())
                                    ...
                                    .executes(commandContext -> {
                                        ...
                                        ControllerConsole controllerConsoleImpl = Objects.requireNonNull(ControllerManager.INSTANCE.getControllerByName(controller)).startControllerConsole(new StdinInputSource().withHistory(UtilKt.getOrCreateControllerHistory(controller)), stdOutPrintTarget, controller);
